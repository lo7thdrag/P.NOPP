...
var
  frmDatabaseLogin: TfrmDatabaseLogin;
...
procedure TfrmDatabaseLogin.btnCancelClick(Sender: TObject);
begin
  Self.Close;
end;

function TfrmDatabaseLogin.getConfig(const Index: Integer): string;
begin
  result := '';
  case index of
    0 : result := Edit1.Text;
...
procedure TfrmDatabaseLogin.setConfig(const Index: Integer;
  const Value: string);
begin
  case index of
    0 :  Edit1.Text := Value;
