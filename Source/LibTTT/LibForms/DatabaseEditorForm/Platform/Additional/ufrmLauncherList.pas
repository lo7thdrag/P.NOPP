...
uses
  uDataModule, ufrmMissileLauncher, ufrmTorpedoLauncher;
...
begin
  ...
  begin
    with FSelectedLauncher.FData do
      dmINWO.DeleteFittedWeaponLauncherOnBoard(Fitted_Weap_Index, Launcher_Type);
  end;
...
begin
  ...
  case FLauncherOwner of
    loMissile: dmINWO.GetFittedWeaponLauncherOnBoard(TMissile_On_Board(FSelectedWeapon).FData.Fitted_Weap_Index,FLauncherList);
    loTorpedo: dmINWO.GetFittedWeaponLauncherOnBoard(TTorpedo_On_Board(FSelectedWeapon).FData.Fitted_Weap_Index,FLauncherList);
  end;
