...
begin
  ...
  FSelectedSonobuoy.FData.Sonar_Instance_Index := dmINWO.GetSonarOnBoardIndexBySonobuoy(FSelectedVehicle.FData.VehicleIndex, FSelectedSonobuoy.FDef.Sonar_Index,
