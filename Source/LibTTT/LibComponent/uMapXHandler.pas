...
uses
  ...
  uCoordConvertor, uConstantaData, Sysutils, Math, uTMapTouch2;
...
//    procedure SetOnToolUsed(const Value: TEventToolMapUsed);
  ...
  public
    ...
    procedure MapDrawUserLayer(ASender: TObject; const Layer: IDispatch; hOutputDC, hAttributeDC: Integer; const RectFull, RectInvalid: IDispatch);
//    procedure MapToolUsed(ASender: TObject; ToolNum: Smallint; X1, Y1, X2, Y2, Distance: double; Shift, Ctrl: WordBool; var EnableDefault: WordBool);
  ...
  public
    ...
    property OnDrawToCanvas: TNotifyDraw read FOnDrawToCanvas write FOnDrawToCanvas;
    property OnMapChange: TNotifyEvent read FOnMapChange write FOnMapChange;
    property OnKeyDown: TMapKeyDown read FOnKeyDown write SetOnKeyDown;
...
begin
  ...
  begin
    if (FMap.CurrentTool = miZoomInTool) then
    begin
